...
screen_width, screeen_height = 800, 600
screen_fill_color = (32, 52, 71)
screen = pygame.display.set_mode((screen_width, screeen_height))

pygame.display.set_caption("Awesone Shooter Game")

FIGHTHER_STEP = 0.4
fighter_image = pygame.image.load('images/fighter.png')
fighter_width, fighter_height = fighter_image.get_size()
fighter_x, fighter_y = screen_width / 2 - \
    fighter_width / 2, screeen_height - fighter_height
...
while game_is_running:
    ...
    if fighter_is_moving_left and fighter_x >= FIGHTHER_STEP:
        fighter_x -= FIGHTHER_STEP

    if fighter_is_moving_right and fighter_x <= screen_width - \
            fighter_width - FIGHTHER_STEP:
        fighter_x += FIGHTHER_STEP
    ...
    game_score_text = game_font.render(f"Your Score is: {game_score}", True,
                                       'white')
...
game_over_rectangle.center = (screen_width / 2, screeen_height / 2)
